...
echo "" 
echo "=== 8. ApiView 应用列表 ==="
#{"renewQuery":false,"measures":["ApiView.allCount","ApiView.uniqApiCount","ApiView.uniqWeakApiCount","ApiView.uniqApiRespSensCount","ApiView.hourCountArray","ApiView.daySum","ApiView.successSum","ApiView.hostSet","ApiView.autoTopoNetwork","ApiView.aggSensScore","ApiView.autoTitleSetStr","ApiView.autoLogo"],"timeDimensions":[{"dimension":"ApiView.ts","dateRange":["2026-03-30T00:00:00.000","2026-03-30T23:59:59.000"]}],"order":{"ApiView.isFavorite":"desc","ApiView.daySum":"desc"},"filters":[{"member":"ApiView.topoNetwork","operator":"notEquals","values":["外发"]}],"dimensions":["ApiView.appId","ApiView.appName","ApiView.dctSection","ApiView.isFavorite"],"segments":["ApiView.org","ApiView.black","ApiView.onePerDay"],"timezone":"Asia/Shanghai"}
