...
echo ""
echo "=== 10. status+sumCount+score+countNum+ts+resSensTs (multi risk detail) ==="
#{"measures":["RiskView.lastStatus","RiskView.allRiskScore","RiskView.countNum","RiskView.ts","RiskView.allRisk"],"timeDimensions":[{"dimension":"RiskView.filterTs","dateRange":"from 15 minutes ago to 15 minutes from now"}],"order":{"RiskView.ts":"desc"},"filters":[],"dimensions":["RiskView.content","RiskView.type","RiskView.filterTs"],"segments":["RiskView.org"],"timezone":"Asia/Shanghai"}
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.lastStatus%22%2C%20%22RiskView.allRiskScore%22%2C%20%22RiskView.countNum%22%2C%20%22RiskView.ts%22%2C%20%22RiskView.allRisk%22%2C%20%22RiskView.lastExpireTs%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22from%2015%20minutes%20ago%20to%2015%20minutes%20from%20now%22%7D%5D%2C%20%22order%22%3A%20%7B%22RiskView.ts%22%3A%20%22desc%22%7D%2C%20%22filters%22%3A%20%5B%5D%2C%20%22dimensions%22%3A%20%5B%22RiskView.content%22%2C%20%22RiskView.type%22%2C%20%22RiskView.filterTs%22%5D%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
echo "Raw result: $result"
check "status+sumCount+score+countNum+ts+resSensTs (multi risk detail)" "$result"
...
echo ""
echo "========================================"
echo "=== RiskView: filterShowTime / listFilterShowTime / statusFilter tests ==="
echo "========================================"

echo ""
echo "=== 17. count + filterShowTime=重复出现 + statusFilter segment ==="
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.count%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22today%22%7D%5D%2C%20%22filters%22%3A%20%5B%7B%22member%22%3A%20%22RiskView.filterShowTime%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%87%8D%E5%A4%8D%E5%87%BA%E7%8E%B0%22%5D%7D%2C%20%7B%22member%22%3A%20%22RiskView.filterRiskLevel%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%AB%98%E9%A3%8E%E9%99%A9%22%2C%20%22%E4%B8%AD%E9%A3%8E%E9%99%A9%22%5D%7D%5D%2C%20%22dimensions%22%3A%20%5B%5D%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%2C%20%22RiskView.whiteFilter%22%2C%20%22RiskView.whiteRiskFilter%22%2C%20%22RiskView.riskDenoiseFilter%22%2C%20%22RiskView.statusFilter%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
check "count + filterShowTime=重复出现 + statusFilter segment" "$result"

echo ""
echo "=== 18. 风险列表 + listFilterShowTime=重复出现 + statusFilter segment ==="
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.ts%22%2C%20%22RiskView.firstTs%22%2C%20%22RiskView.status%22%2C%20%22RiskView.data%22%2C%20%22RiskView.riskClues%22%2C%20%22RiskView.isRealtimeRule%22%2C%20%22RiskView.filters%22%2C%20%22RiskView.orderBy%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22today%22%7D%5D%2C%20%22order%22%3A%20%5B%5B%22RiskView.filterScore%22%2C%20%22desc%22%5D%2C%20%5B%22RiskView.ts%22%2C%20%22desc%22%5D%5D%2C%20%22filters%22%3A%20%5B%7B%22member%22%3A%20%22RiskView.listFilterShowTime%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%87%8D%E5%A4%8D%E5%87%BA%E7%8E%B0%22%5D%7D%2C%20%7B%22member%22%3A%20%22RiskView.filterRiskLevel%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%AB%98%E9%A3%8E%E9%99%A9%22%2C%20%22%E4%B8%AD%E9%A3%8E%E9%99%A9%22%5D%7D%5D%2C%20%22dimensions%22%3A%20%5B%22RiskView.risk%22%2C%20%22RiskView.host%22%2C%20%22RiskView.channel%22%2C%20%22RiskView.filterRiskLevel%22%2C%20%22RiskView.type%22%2C%20%22RiskView.content%22%2C%20%22RiskView.filterScore%22%2C%20%22RiskView.nameGroup%22%5D%2C%20%22limit%22%3A%2020%2C%20%22offset%22%3A%200%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%2C%20%22RiskView.whiteFilter%22%2C%20%22RiskView.whiteRiskFilter%22%2C%20%22RiskView.riskDenoiseFilter%22%2C%20%22RiskView.statusFilter%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
check "risk list + listFilterShowTime=重复出现 + statusFilter segment" "$result"

echo ""
echo "=== 19. count + filterShowTime=首次出现 + statusFilter segment ==="
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.count%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22today%22%7D%5D%2C%20%22filters%22%3A%20%5B%7B%22member%22%3A%20%22RiskView.filterShowTime%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%A6%96%E6%AC%A1%E5%87%BA%E7%8E%B0%22%5D%7D%2C%20%7B%22member%22%3A%20%22RiskView.filterRiskLevel%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%AB%98%E9%A3%8E%E9%99%A9%22%2C%20%22%E4%B8%AD%E9%A3%8E%E9%99%A9%22%5D%7D%5D%2C%20%22dimensions%22%3A%20%5B%5D%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%2C%20%22RiskView.whiteFilter%22%2C%20%22RiskView.whiteRiskFilter%22%2C%20%22RiskView.riskDenoiseFilter%22%2C%20%22RiskView.statusFilter%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
check "count + filterShowTime=首次出现 + statusFilter segment" "$result"

echo ""
echo "=== 20. 风险列表 + listFilterShowTime=首次出现 + statusFilter segment ==="
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.ts%22%2C%20%22RiskView.firstTs%22%2C%20%22RiskView.status%22%2C%20%22RiskView.data%22%2C%20%22RiskView.riskClues%22%2C%20%22RiskView.isRealtimeRule%22%2C%20%22RiskView.filters%22%2C%20%22RiskView.orderBy%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22today%22%7D%5D%2C%20%22order%22%3A%20%5B%5B%22RiskView.filterScore%22%2C%20%22desc%22%5D%2C%20%5B%22RiskView.ts%22%2C%20%22desc%22%5D%5D%2C%20%22filters%22%3A%20%5B%7B%22member%22%3A%20%22RiskView.listFilterShowTime%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%A6%96%E6%AC%A1%E5%87%BA%E7%8E%B0%22%5D%7D%2C%20%7B%22member%22%3A%20%22RiskView.filterRiskLevel%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%AB%98%E9%A3%8E%E9%99%A9%22%2C%20%22%E4%B8%AD%E9%A3%8E%E9%99%A9%22%5D%7D%5D%2C%20%22dimensions%22%3A%20%5B%22RiskView.risk%22%2C%20%22RiskView.host%22%2C%20%22RiskView.channel%22%2C%20%22RiskView.filterRiskLevel%22%2C%20%22RiskView.type%22%2C%20%22RiskView.content%22%2C%20%22RiskView.filterScore%22%2C%20%22RiskView.nameGroup%22%5D%2C%20%22limit%22%3A%2020%2C%20%22offset%22%3A%200%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%2C%20%22RiskView.whiteFilter%22%2C%20%22RiskView.whiteRiskFilter%22%2C%20%22RiskView.riskDenoiseFilter%22%2C%20%22RiskView.statusFilter%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
check "risk list + listFilterShowTime=首次出现 + statusFilter segment" "$result"

echo ""
echo "=== 21. count + filterStatus=待确认 (equals, 无 statusFilter segment) ==="
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.count%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22today%22%7D%5D%2C%20%22filters%22%3A%20%5B%7B%22member%22%3A%20%22RiskView.filterStatus%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E5%BE%85%E7%A1%AE%E8%AE%A4%22%5D%7D%2C%20%7B%22member%22%3A%20%22RiskView.filterRiskLevel%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%AB%98%E9%A3%8E%E9%99%A9%22%2C%20%22%E4%B8%AD%E9%A3%8E%E9%99%A9%22%5D%7D%5D%2C%20%22dimensions%22%3A%20%5B%5D%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%2C%20%22RiskView.whiteFilter%22%2C%20%22RiskView.whiteRiskFilter%22%2C%20%22RiskView.riskDenoiseFilter%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
check "count + filterStatus=待确认 (equals operator)" "$result"

echo ""
echo "=== 22. 风险列表 + filterStatus=待确认 (equals, 无 statusFilter segment) ==="
result=$(curl -s "$BASE/load?queryType=multi&query=%7B%22measures%22%3A%20%5B%22RiskView.ts%22%2C%20%22RiskView.firstTs%22%2C%20%22RiskView.status%22%2C%20%22RiskView.data%22%2C%20%22RiskView.riskClues%22%2C%20%22RiskView.isRealtimeRule%22%2C%20%22RiskView.filters%22%2C%20%22RiskView.orderBy%22%5D%2C%20%22timeDimensions%22%3A%20%5B%7B%22dimension%22%3A%20%22RiskView.filterTs%22%2C%20%22dateRange%22%3A%20%22today%22%7D%5D%2C%20%22order%22%3A%20%5B%5B%22RiskView.filterScore%22%2C%20%22desc%22%5D%2C%20%5B%22RiskView.ts%22%2C%20%22desc%22%5D%5D%2C%20%22filters%22%3A%20%5B%7B%22member%22%3A%20%22RiskView.filterStatus%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E5%BE%85%E7%A1%AE%E8%AE%A4%22%5D%7D%2C%20%7B%22member%22%3A%20%22RiskView.filterRiskLevel%22%2C%20%22operator%22%3A%20%22equals%22%2C%20%22values%22%3A%20%5B%22%E9%AB%98%E9%A3%8E%E9%99%A9%22%2C%20%22%E4%B8%AD%E9%A3%8E%E9%99%A9%22%5D%7D%5D%2C%20%22dimensions%22%3A%20%5B%22RiskView.risk%22%2C%20%22RiskView.host%22%2C%20%22RiskView.channel%22%2C%20%22RiskView.filterRiskLevel%22%2C%20%22RiskView.type%22%2C%20%22RiskView.content%22%2C%20%22RiskView.filterScore%22%2C%20%22RiskView.nameGroup%22%5D%2C%20%22limit%22%3A%2020%2C%20%22offset%22%3A%200%2C%20%22segments%22%3A%20%5B%22RiskView.org%22%2C%20%22RiskView.whiteFilter%22%2C%20%22RiskView.whiteRiskFilter%22%2C%20%22RiskView.riskDenoiseFilter%22%5D%2C%20%22timezone%22%3A%20%22Asia%2FShanghai%22%7D")
check "risk list + filterStatus=待确认 (equals operator)" "$result"
